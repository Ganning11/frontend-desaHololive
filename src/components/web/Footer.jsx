      ...
      <div className="container-fluid footer-top">
        <div className="row p-4">
          <div className="col-md-4 mb-4 mt-3">
            <h5>
              TENTANG
              <strong style={{ color: "#ffd22e" }}> DESA HOLOLIVE</strong>
            </h5>
            <hr />
            ...
            <p className="text-justify mt-3">
              Desa Hololive merupakan desa tempat tinggal anggota hololive.
            </p>
          </div>
          <div className="col-md-4 mb-4 mt-3">
            <h5>
          ...
          <div className="col-md-4 mb-4 mt-3">
            ...
            <p>
              ...
              <br />
              <br />
              <i className="fas fa-envelope"></i> info@desa-hololive.com
              <br />
              <br />
      ...
      <div className="container-fluid footer-bottom">
        <div className="row p-3">
          <div className="text-center text-white font-weight-bold">
            Copyright © 2024 DESA HOLOLIVE. All Rights Reserved.
          </div>
        </div>
      </div>
    </footer>
